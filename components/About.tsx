              ...
              >
                ...
                >
                  <p className="text-xl text-gray-700 leading-relaxed italic">
                    <div>
                      <h1>
                        &quot;HackFusion-25&quot;: Where Innovation Meets
                        Opportunity
                      </h1>
                    </div>
                  </p>
                  ...
                  {[
                    {
                      ...
                      title: 'Inclusive',
                      description:
                        'Open to all departments, embracing diverse perspectives',
                    },
                    {
                      icon: BookOpenCheck,
                      title: 'Three-Round Challenge',
                      description:
                        'Rigorous evaluation process for innovative solutions',
                    },
                    {
                      icon: Globe,
                      title: 'Real-World Impact',
                      description:
                        'Transform ideas into practical technological solutions',
                    },
                    {
                      icon: StarIcon,
                      title: 'Professional Growth',
                      description:
                        'Develop skills beyond traditional classroom learning',
                    },
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
            ...
            <div className="rounded-3xl bg-gray-300 max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-600 leading-relaxed mt-4">
                  Whether it&apos;s a software application, a hardware
                  prototype, or a unique tech concept, HackFusion-25 offers
                  participants a chance to transform their ideas into reality.
                  This event isn&apos;t limited to any one field—it&apos;s open
                  to all departments, embracing diversity in thought, skill, and
                  innovation.
                </p>
              </motion.div>
            </div>
            ...
            {[
              {
                ...
                description:
                  'Fill in the form and submit your written abstract by 10 AM on 25th December 2024.',
              },
              {
                number: 2,
                color: 'green',
                ...
                description:
                  'Shortlisted students will present their problem statement and innovative solution to an expert panel on 6th-8th January.',
              },
              {
                number: 3,
                color: 'green',
                ...
                description:
                  'A 6-hour hackathon at our campus including mentoring sessions, expert evaluations, and result announcement.',
              },
            ].map((round, index) => (
              <motion.div
                key={round.number}
              ...
              >
                <span
                  className={`bg-${round.color}-500 text-white rounded-full h-8 w-8 flex items-center justify-center mr-4 flex-shrink-0`}
                >
                  {round.number}
                </span>

                <div>
                  <h3 className={`font-semibold text-${round.color}-700`}>
                    {round.title}
                  </h3>
            ...
            {[
              {
                ...
                description:
                  'Teams must have 4-5 members, with at least one female participant.',
              },
              {
                number: 2,
                title: 'Registration',
                description:
                  'The team leader must handle the registration and abstract submission.',
              },
              {
                number: 3,
                title: 'Submission Deadline',
                description:
                  'Abstract submissions close at 10:00 AM on January 2025',
              },
              {
                number: 4,
                title: 'Problem Domain',
                description:
                  'Teams may choose problem statements from any provided domain.',
              },
              {
                number: 5,
                title: 'Selection Process',
                description:
                  'Shortlisted teams will move to the presentation and final hackathon rounds.',
              },
              {
                number: 6,
            ...
            {[
              {
                ...
                description:
                  'Students form interdisciplinary teams, learn to share ideas, respect diverse perspectives, and achieve collective goals.',
              },
              {
                title: 'Ignites Innovation',
                description:
                  'By tackling challenging problems, students unlock their creativity and bring unique solutions to life.',
              },
              {
                title: 'Builds Confidence',
                description:
                  'Presenting solutions to expert panels helps students improve communication, overcome fear, and gain confidence in their abilities.',
              },
              {
              ...
              },
              {
                ...
                description:
                  'From team management to problem-solving, HackFusion trains students to lead projects, adapt to dynamic challenges, and excel under pressure.',
              },
              {
                title: 'Encourages Inclusivity and Diversity',
                description:
                  'By mandating interdisciplinary teams with gender inclusivity, HackFusion promotes equal opportunities for all students, fostering a culture of respect and collaboration.',
              },
            ].map((benefit, index) => (
              <motion.div
                key={index}
