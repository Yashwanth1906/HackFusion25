  ...
  <div className="rounded-3xl bg-gray-300 max-w-4xl mx-auto">
    ...
    >
      ...
      <p className="text-lg text-gray-600 leading-relaxed mt-4">
        Whether it's a software application, a hardware prototype, or a unique tech concept, HackFusion-25 offers participants a chance to transform their ideas into reality. This event isn't limited to any one field—it's open to <b>all departments</b>, embracing diversity in thought, skill, and innovation.
      </p>
    </motion.div>
  </div>
</motion.section>
